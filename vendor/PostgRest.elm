...
import Url as Builder exposing (QueryParameter)
...
{-| -}
schema : String -> id -> attributes -> Schema id attributes
schema name _ s =
    Schema name s
...
{-| -}
hasOne : String -> id -> Relationship HasOne id
hasOne s _ =
    Relationship s


{-| -}
hasMany : String -> id -> Relationship HasMany id
hasMany s _ =
    Relationship s


{-| -}
hasNullable : String -> id -> Relationship HasNullable id
hasNullable s _ =
    Relationship s
